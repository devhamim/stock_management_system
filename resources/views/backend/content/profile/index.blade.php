        ...
        <div class="col-lg-12">
            <div class="card car-transparent">
                <div class="card-body p-0">
                    ...
                    <img src="{{ asset('assets/images/page-img/profile.png') }}" class="img-fluid rounded w-100" style="height: 40vh" alt="profile-image">
                    {{-- <img src="{{ asset('assets/images/page-img/profile-bg.jpg') }}" class="img-fluid rounded w-100" alt="profile-image"> --}}
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="profile-img position-relative">
                        @if(Auth::user()->image != null)
                            <img src="{{ asset('uplode/profile') }}/{{ Auth::user()->image }}" class="img-fluid rounded avatar-110" alt="profile-image">
                        @else
                            <img src="{{ asset('assets') }}/images/user/1.png" class="img-fluid rounded avatar-110" alt="profile-image">
                        @endif
                    </div>
                    <div class="ml-3">
                    ...
                    <div class="text-center">
                        <p href="" class="btn btn-primary font-size-14">Contact</p>
                    </div>
